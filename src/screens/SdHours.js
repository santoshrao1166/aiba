    ...
    axiosPost(
      ...
      orderCreation => {
        ...
        let options = {
          ...
          image: 'https://www.aibaonline.in/images/shoppers_darbaar_logo.png',
          currency: 'INR',
        ...
        RazorpayCheckout.open(options)
          .then(async response => {
            ...
            navigation.navigate('Multi SD Live Bookings');
          })
          .catch(error => {
            clearUserCart();
  ...
  return (
    ...
    >
      ...
      <View style={{ marginHorizontal: width * 0.05, flex: 1 }}>
        ...
        <TouchableOpacity
              onPress={() => navigation.navigate('Multi SD Live Bookings')}
              style={{
                padding: 10,
                marginTop: 20,
